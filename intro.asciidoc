...
Metamask calculates the average gas price of recent successful transactions is 3 GWEI, which stands for 3 gigawei. Wei is the smallest subdivision of the ether currency, as we discussed in <<ether_units>>. And the gas cost of sending a basic transaction is 21000 gas units. Therefore, the maximum amount of ETH you spend  is 3 * 21000 GWEI = 63000 GWEI = 0.000063 ETH.
...
image::images/remix_withdraw.png["Click "withdraw" in Remix to create a withdrawal transaction"]
